...
# Get the webcam q
webcam_video_stream = cv2.VideoCapture('media/video.mp4')
...
benjamin_image2 = face_recognition.load_image_file('media/Benjamin2.jpg')
benjamin_face_encodings2 = face_recognition.face_encodings(benjamin_image2)[0]
...
known_face_encodings = [benjamin_face_encodings,benjamin_face_encodings2,trump_face_encodings]
known_face_names = ["Benjamin Netanyahu","Benjamin Netanyahu","Donald Trump"]
