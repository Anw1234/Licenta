# -*- coding: utf-8 -*-
"""
Created on Sat Apr  5 17:02:25 2022
...
image_to_detect = cv2.imread('media/Andrei.jpg')
...
for index,current_face_location in enumerate(all_face_locations):
    ...
    # Predicting Age
    # declaring the labels
    age_label_list = ['(0-2)', '(4-6)', '(8-12)', '(15-20)', '(20-25)', '(25-32)', '(38-43)', '(48-53)', '60+']
    # declaring the file paths
    ...
    cv2.putText(image_to_detect, gender+" "+age+"years", (left_pos,bottom_pos+20), font, 0.5, (0,0,0),1)
